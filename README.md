...
Dogfooded against 17+ real, in-the-wild MCP servers (up to 50k★) — 17 genuine bugs found and fixed, one PR [merged upstream](https://github.com/homeassistant-ai/ha-mcp/pull/2327) into a 4.5k★ repo. See [Real-world spot check](#real-world-spot-check) below.
